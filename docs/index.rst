...
Examples
--------
| `UART client <https://components.espressif.com/components/plasmapper/pl_modbus/versions/1.4.1/examples/uart_client>`_
| `Network client <https://components.espressif.com/components/plasmapper/pl_modbus/versions/1.4.1/examples/network_client>`_
| `UART server <https://components.espressif.com/components/plasmapper/pl_modbus/versions/1.4.1/examples/uart_server>`_
| `USB server <https://components.espressif.com/components/plasmapper/pl_modbus/versions/1.4.1/examples/usb_server>`_
| `Network server <https://components.espressif.com/components/plasmapper/pl_modbus/versions/1.4.1/examples/network_server>`_
| `Server memory areas <https://components.espressif.com/components/plasmapper/pl_modbus/versions/1.4.1/examples/server_memory_areas>`_
| `Server user-defined function <https://components.espressif.com/components/plasmapper/pl_modbus/versions/1.4.1/examples/server_user_defined_function>`_
